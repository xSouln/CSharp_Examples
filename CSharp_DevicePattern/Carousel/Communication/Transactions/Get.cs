...
namespace Carousel.Communication.Transactions
{
    public class Get
    {
        ...
        public static Transaction<ResponseGetPositionT> Position = new Transaction<ResponseGetPositionT>(Action.GET_POSITION);
        public static Transaction<ResponseGetMotionStateT> MotionState = new Transaction<ResponseGetMotionStateT>(Action.GET_MOTION_STATE);
        public static Transaction<CalibrationT> Calibration = new Transaction<CalibrationT>(Action.GET_CALIBRATION);
